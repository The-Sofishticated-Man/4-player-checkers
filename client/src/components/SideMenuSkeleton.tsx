...
function SideMenuSkeleton() {
  return (
    <div
      className="fixed right-[66px] top-1/2 z-40 h-[min(860px,calc(100vh-2rem))] w-[340px] max-w-[calc(100vw-2rem)] -translate-y-1/2 rounded-2xl border p-4 backdrop-blur-md"
      style={panelTheme}
    >
